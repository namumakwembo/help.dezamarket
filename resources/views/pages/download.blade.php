...
<div class="grid h-full mx-auto items-center space-y-2 rounded-2xl max-w-sm bg-gray-50 border dark:border-gray-700 dark:bg-gray-800 p-3 my-16 ">

    <span class="bg-gray-200 dark:bg-gray-700 dark:text-white text-gray-500 rounded-full p-2 px-2.5 max-w-max">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-android2 w-6 h-7" viewBox="0 0 16 16">
    ...
    <h5 class="text-sm text-gray-900 dark:text-white">Phone / Tablet</h5>

    <h2 class="text-2xl font-bold dark:text-gray-300 dark:font-semibold">Android</h2> 

     <p class=" dark:text-white">
        The fastest way to sell anything locally in Zambia. Whether it's gadgets, cars, or real estate, Dezamarket is your go-to app for quick and easy sales.
    </p>

  

    <div class=" w-full mx-auto  flex flex-col     py-4  gap-y-5">
        
    
        <a href="https://play.google.com/store/apps/details?id=com.dezamarket.app" class="w-full">
      
        <button class="bg-black rounded-lg w-full flex items-center gap-x-3 justify-center text-white hover:bg-black/80 duration-300 transition-colors border border-transparent px-2 py-2.5">
